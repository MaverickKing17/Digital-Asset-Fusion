        ...
        <div className="relative overflow-hidden bg-white border border-brand-gold/30 p-8 md:p-12 shadow-[0_0_25px_rgba(212,175,55,0.15)] hover:shadow-[0_0_35px_rgba(212,175,55,0.25)] transition-shadow duration-500 rounded-sm">
            ...
            <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-2xl md:text-3xl font-serif text-gray-900 font-bold">
                        Full Transparency: Your Zero-Liability Asset
                    </h2>
                </div>
                
                <h3 className="text-lg font-bold text-gray-900 mb-6 font-sans tracking-tight">
                    Immediate Trust: Validated Provenance & Sustainability Data.
                </h3>
                
                <div className="prose prose-lg text-gray-900 font-semibold leading-relaxed mb-8">
                    <p className="mb-4">
                ...
                <div className="space-y-4">
                    <div className="flex items-start gap-4 text-sm text-gray-900 bg-brand-gray/50 p-4 rounded-sm border border-gray-200">
                        <FileCheck className="w-5 h-5 text-brand-gold flex-shrink-0 mt-0.5" />
                        <span className="font-bold"><strong>SEO Clean Slate:</strong> Includes a professionally assembled Google Disavow File to neutralize historical links.</span>
                    </div>
                    <div className="flex items-start gap-4 text-sm text-gray-900 bg-brand-eco/5 p-4 rounded-sm border border-brand-eco/20">
                        <Leaf className="w-5 h-5 text-brand-eco flex-shrink-0 mt-0.5" />
                        <span className="font-bold"><strong>Sustainability Assurance:</strong> All tokenized materials include embedded carbon footprint data, preparing for 2026's eco-focused regulations.</span>
                    </div>
                </div>
            </div>
        </div>
